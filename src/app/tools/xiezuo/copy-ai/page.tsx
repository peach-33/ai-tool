    ...
    <div className="container">
      <div className="content">
        <div className="hero-section">
          ...
          <div className="hero-content">
            ...
            <div className="right-content">
              <Image 
                src="/copy.ai-page.png"
                alt="Copy.ai Screenshot"
                width={600}
                height={400}
                style={{
                  width: '100%',
        ...
        <section className="section">
          ...
          Copy.ai是一款AI驱动的文案写作工具，旨在帮助企业和个人快速生成高质量的营销文案和内容。它利用先进的AI技术，提供多样化的内容类型生成，包括电子邮件、社交媒体帖子和博客文章等。
          </p>
        </section>
        ...
        <section className="section">
          ...
          <div className="user-grid">
            <div className="user-card">
              <h3 className="user-title" style={{ textAlign: 'center' }}>营销人员和内容创作者</h3>
              <p className="user-desc" style={{ textAlign: 'center' }}>需要撰写引人注目的社交媒体帖子、营销邮件和吸引人的产品描述的专业人士。</p>
            </div>
            <div className="user-card">
              <h3 className="user-title" style={{ textAlign: 'center' }}>企业和品牌</h3>
              <p className="user-desc" style={{ textAlign: 'center' }}>寻求通过自动化任务和高质量内容创作来提升市场竞争力的企业和品牌。</p>
            </div>
          </div>
        </section>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p className="feature-desc">
                利用人工智能技术快速生成高质量的文案内容
              </p>
            </div>
            <div className="feature-card">
              <h3>多样化的内容类型</h3>
              <p className="feature-desc">
                支持生成各种类型的内容，包括电子邮件、社交媒体帖子、博客文章等
              </p>
            </div>
            <div className="feature-card">
              <h3>编辑和润色工具</h3>
              <p className="feature-desc">
                提供内置编辑功能，帮助优化内容品质，使生成的文案更具专业性与吸引力
              </p>
            </div>
          </div>
        </section>
